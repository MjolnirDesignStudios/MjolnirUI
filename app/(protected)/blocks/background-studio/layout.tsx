...
export const metadata = {
  title: "Background Studio • MjolnirUI",
  description: "Animated gradient meshes, particle fields, and shader backgrounds — interactive designer.",
};

export default function BackgroundStudioLayout({
  children,
}: {
